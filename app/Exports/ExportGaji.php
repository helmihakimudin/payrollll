...
class ExportGaji implements FromView,WithEvents
{
    ...
    {
       $data = Employee::leftjoin('payroll_employee_component','employees.id','=','payroll_employee_component.employee_id')->leftjoin('import_payrolls','employees.id','=','import_payrolls.employee_id')->leftjoin('pay_slips','employees.id','=','pay_slips.employee_id')->leftjoin('job_position','employees.job_position_id','=','job_position.id')
                            ...
                            ->get();
        $karyawan = $data->unique('employee_id');
