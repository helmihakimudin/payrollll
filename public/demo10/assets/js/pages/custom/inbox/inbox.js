...
var KTAppInbox = (function () {
    ...
    return {
        ...
        //     KTUtil.on(
        //         asideEl,
        //         '.kt-nav__item .kt-nav__link[data-action="list"]',
        //         "click",
        //         function (e) {
        ...
        //             var navItemActiveEl = KTUtil.find(
        //                 asideEl,
        ...
        initList: function () {
            ...
            KTUtil.on(
                listEl,
                ".kt-inbox__toolbar .kt-inbox__check .kt-checkbox input",
                "click",
                function () {
                    var items = KTUtil.findAll(
                        listEl,
                        ".kt-inbox__items .kt-inbox__item"
                    );

                    for (var i = 0, j = items.length; i < j; i++) {
                        var item = items[i];
                        var checkbox = KTUtil.find(
                            item,
                            ".kt-inbox__actions .kt-checkbox input"
                        );
            ...
            KTUtil.on(
                listEl,
                ".kt-inbox__item .kt-checkbox input",
                "click",
                function () {
        ...
        initView: function () {
            ...
            KTUtil.on(
                viewEl,
                ".kt-inbox__toolbar .kt-inbox__icon.kt-inbox__icon--back",
                "click",
                function () {
                    // demo loading
                    var loading = new KTDialog({
            ...
            KTUtil.on(
                viewEl,
                ".kt-inbox__messages .kt-inbox__message .kt-inbox__head",
                "click",
                function (e) {
                    var dropdownToggleEl = KTUtil.find(
                        this,
                        ".kt-inbox__details .kt-inbox__tome .kt-inbox__label"
                    );
                    var groupActionsEl = KTUtil.find(
                        this,
                        ".kt-inbox__actions .kt-inbox__group"
                    );
                    ...
                    if (
                        ...
                        (dropdownToggleEl &&
                            dropdownToggleEl.contains(e.target) === true)
                    ) {
                        return false;
                    }
                    ...
                    if (
                        ...
                        (groupActionsEl &&
                            groupActionsEl.contains(e.target) === true)
                    ) {
                        return false;
                    }
                    ...
                    if (
                        KTUtil.hasClass(message, "kt-inbox__message--expanded")
                    ) {
                        KTUtil.removeClass(
                            message,
        ...
        //     KTUtil.on(
        //         viewEl,
        //         ".kt-inbox__reply .kt-inbox__actions .btn",
        //         "click",
        //         function (e) {
        ...
        //     KTUtil.on(
        //         viewEl,
        //         ".kt-inbox__message .kt-inbox__actions .kt-inbox__group .kt-inbox__icon.kt-inbox__icon--reply",
        //         "click",
        //         function (e) {
        ...
        //     KTUtil.on(
        //         viewEl,
        //         ".kt-inbox__reply .kt-inbox__foot .kt-inbox__icon--remove",
        //         "click",
        //         function (e) {
        //             var reply = this.closest(".kt-inbox__reply");
        ...
        //     KTUtil.on(
        //         composeEl,
        //         ".kt-inbox__form .kt-inbox__foot .kt-inbox__secondary .kt-inbox__icon.kt-inbox__icon--remove",
        //         "click",
        //         function (e) {
        //             swal.fire({
