    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">Add Attendance Location</h3>
            </div>
        ...
        <div class="kt-portlet__body">
            <form class="kt-form">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="kt-radio-inline">
                                <label class="kt-radio kt-radio--bold kt-radio--success">
                                    <input type="radio" name="example_2" checked value="0"> WFO
                                    <span></span>
                                </label>
                                <label class="kt-radio kt-radio--bold kt-radio--success">
                                    <input type="radio" name="example_2" value="1"> WFH
                                    <span></span>
                                </label>
                            </div>
                    ...
                    <div class="col-lg-6 location" style="display:none">
                        <div class="form-group">
