...
<div class="modal-body">
    <form action="{{route('employee.account.education.informal.update',$education->id)}}" method="POST" class="form" id="form-education-informal" enctype="multipart/form-data">
        {{ csrf_field() }}
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
