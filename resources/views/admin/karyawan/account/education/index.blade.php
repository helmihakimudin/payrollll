                ...
                <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <a href="javascript:;" data-attr="{{route('employee.account.education.create',$karyawan->id)}}" class="btn btn-default  btn-icon-sm btn-sm btn-add-education">
                ...
                <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <a href="javascript:;" data-attr="{{route('employee.account.education.informal.create',$karyawan->id)}}" class="btn btn-default  btn-icon-sm btn-sm btn-add-education-informal">
                                    <i class="la la-list"></i>
                                    Add 
                                </a>
                            </div>
                ...
                <div class="tab-pane" id="kt_apps_contacts_view_tab_3" role="tabpanel">
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <a href="javascript:;" data-attr="{{route('employee.account.education.working.create',$karyawan->id)}}" class="btn btn-default  btn-icon-sm btn-sm btn-add-education-working">
                                    <i class="la la-list"></i>
                                    Add 
                                </a>
                            </div>
...
@endphp
@endsection
@include('admin.karyawan.account.education.modal')
@push('scriptjs')
<script>
...
$(document).ready(function(){
    var datatable1 = $("#formal-education").DataTable({
        ...
        serverSide:true,
        ajax:{
            url:'{{ route('employee.account.education.ajax') }}',
            type:'post',
    ...
    var datatable2 = $("#informal-education").DataTable({
        ...
        serverSide:true,
        ajax:{
            url:'{{ route('employee.account.education.informal.ajax') }}',
            type:'post',
            data:{"_token": "{{ csrf_token() }}","id":karyawan_id},
        },
        columns:[
    ...
    var datatable3 = $("#working-experience").DataTable({
        ...
        serverSide:true,
        ajax:{
            url:'{{ route('employee.account.education.working.ajax') }}',
            type:'post',
            data:{"_token": "{{ csrf_token() }}","id":karyawan_id},
        },
        columns:[
