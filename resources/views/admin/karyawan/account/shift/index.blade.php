            ...
            <form class="kt-form" action="">
              <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control kt-select2 w-100" id="new-shift" name="new-shift">
                        <option></option>
                        <option>dayoff (in: 00:00:00 | out: 00:00:00 )</option>
                        <option>M (in: 10:00:00 | out: 17:00:00 )</option>
                        <option>TM1 (in: 11:00:00 | out: 19:00:00 )</option>
                    </select>
                </div>
