...
<div class="modal-body">
    <form action="{{route('employee.account.personal.emergency.update',$emergency->id)}}" method="POST" class="form" id="form-personal-emergency" enctype="multipart/form-data">
        {{ csrf_field() }}
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
