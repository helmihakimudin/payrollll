        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{$karyawan->account_number}}" class="form-control">
                </div>
                <div class="form-group">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{$karyawan->bank_name}}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="account-holder-name">Bank Account Holder Name</label>
                    <input type="text" value="{{$karyawan->account_holder_name}}"class="form-control">
                </div>
            </div>
       </div>
    </div>
