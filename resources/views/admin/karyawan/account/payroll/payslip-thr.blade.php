        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table kt-datatable__tabletable-checkable dataTable no-footer dtr-inline karyawan-table" style="font-size:11px;" id="payslip">
                    ...
                    <tbody>
                        <tr>
                            <td>{{\Carbon\Carbon::parse($karyawan->thr->created_at)->format("F Y")}}</td>
                            <td>
                                <a href="{{route('employee.payroll.payslip.thr.detail',$karyawan->id)}}" class="btn btn-secondary btn-sm" title="View Payslip">
                                    View Payslip THR
                                </a>
                            </td>
                        </tr>
