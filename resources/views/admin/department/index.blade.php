...
<div class="kt-body kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-grid--stretch" id="kt_body">
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                ...
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__group" id="kt_subheader_search">
                        <span class="kt-subheader__desc" id="kt_subheader_total">
                            <a href="javascript:;" data-attr="{{route('department.create')}}" class="btn btn-primary rounded-fill btn-add">Add Department</a></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="kt-container  kt-grid__item kt-grid__item--fluid">
            <div class="row">
                <div class="col-lg-12">
                    <table class="table kt-datatable__tabletable-checkable dataTable no-footer dtr-inline karyawan-table" style="font-size:11px;" id="department-table" >
                        <thead>
                            <tr role="row">
                                <th>Branch Office</th>
                                <th>Department</th>
...
$(document).ready(function(){
    var datatable1 = $("#department-table").DataTable({
