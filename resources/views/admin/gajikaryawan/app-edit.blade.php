	...
	<div class="kt-subheader  kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			<div class="kt-subheader__main">
                ...
                @can('Hapus Gaji')
				<a href="{{ route('gaji.destroy',$karyawan->id)}}" class="btn btn-outline-danger btn-elevate btn-icon-sm" title="Delete">
			...
			<div class="kt-subheader__toolbar">
				<div class="kt-subheader__wrapper">
					<a href="{{route('gaji')}}" class="btn btn-secondary btn-elevate btn-icon-sm">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit-y">
                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            <div class="kt-widget__head">
                                ...
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__action">
                                        <a href="https://api.whatsapp.com/send?phone=+62{{substr($karyawan->phone,1)}}" target="_blank" class="btn btn-outline-brand btn-sm">
                            ...
                            <div class="kt-widget__body">
                                ...
                                <div class="kt-widget__items nav-pills" role="tablist">
                                  <ul class="nav nav-pills nav-fill flex-column" role="tablist">
                                      <li class="nav-item">
                                          <a class="nav-link kt-widget__item active" data-toggle="tab" href="#kt_tabs_5_1">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link kt-widget__item" data-toggle="tab" href="#kt_tabs_5_2">
                                          <span class="kt-widget__section">
                                              <span class="kt-widget__icon">
                                      ...
                                      <li class="nav-item">
                                          <a class="nav-link kt-widget__item" data-toggle="tab" href="#kt_tabs_5_3">
                                            <span class="kt-widget__section">
                                                <span class="kt-widget__icon">
                      ...
                      <div class="kt-portlet__body">
                        <div class="row">
                          <div class="col-lg-4">
                            ...
                            <p>Prorate settings</p>
                            <p>Overtime settings</p>
                            <p>Payment schedule overtime</p>
                            <p>Cost center</p>
                            <p>Cost center category</p>
                            <p>Currency</p>
                          </div>
                          <div class="col-lg-8 kt-font-bold">
                            <p>Rp9.500.000</p>
                            <p>Monthly</p>
                            <p>Default</p>
                            <p>Based on Working Day</p>
                            <p>Eligible</p>
                            <p>-</p>
                            <p>Not yet set</p>
                            <p>Not yet set</p>
