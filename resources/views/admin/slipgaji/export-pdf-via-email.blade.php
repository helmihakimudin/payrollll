@php 
    ...
    $employee = \App\Karyawan::find($payslip->employee_id);
    $desgination = \App\Designation::find($employee->designation_id);
    $signature = \App\User::find($payslip->created_by);
@endphp 
<style>
  #border{
        border-style: solid;
        ...
        <div id="all-section">
            ...
            <div id="signature">
                <span class="text-small" >
                    ...
                    <img src="{{ public_path('storage/logo/'.$signature->signature)}}" width="30%" alt="">
                    </div>
