            ...
            <div class="kt-widget kt-widget--users kt-mt-20">
                ...
                <div style="height: 315px; overflow-y:scroll;">
                    <form method="POST" id="form-employee">
                        @csrf
                        <div class="kt-widget__items" id="items">
...
<div class="modal-footer">
    ...
    <button type="submit" form="form-employee" formaction="{{route('payroll.component.employee.delete')}}" class="btn btn-danger">Delete</button>
    <button type="submit" form="form-employee" formaction="{{route('payroll.component.edit.employee.store',$payrollcomponent_id)}}" class="btn btn-primary">Save</button>
</div>