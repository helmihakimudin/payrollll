...
<div class="modal-body">
    <form action="{{route('payroll.setting.component.store')}}" method="POST" class="form" id="form-allowance-option" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-group">
            <label>Allowance</label>
            <input type="text" class="form-control" name="name"  placeholder="Enter Allowance">
            <input type="hidden" class="form-control" name="type"  value="Allowance"p>
        </div>
    </form>
</div>
