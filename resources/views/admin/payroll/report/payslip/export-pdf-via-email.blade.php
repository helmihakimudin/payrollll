@php
    $payslip = \App\Payslip::join('employees','pay_slips.employee_id','=','employees.id')
     ...
     <div id="third-section">
        <div id="third-section-left">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td id="td-table">ID / Name </td><td id="td-table">:</td><td id="td-table">@if(isset($payslip->employee_id)) {{$payslip->employee_id}} @endif / @if(isset($payslip->full_name)) {{$payslip->full_name}} @endif </td>
                    </tr>
                    <tr>
                        <td id="td-table">Organization </td><td id="td-table">:</td><td id="td-table">@if(isset($payslip->organization)) {{$payslip->organization}} @endif</td>
                    </tr>
                    <tr>
                        <td id="td-table">Job Level </td><td id="td-table">:</td><td id="td-table">@if(isset($payslip->job_level)) {{$payslip->job_level}} @endif</td>
                    </tr>
                <tbody>
            </table>
        </div>
        <div id="third-section-right">
            <table class="table">
                <tbody>
                    <tr>
                        <td id="td-table">Job Position</td><td id="td-table">:</td><td id="td-table">@if(isset($payslip->job_position)) {{$payslip->job_position}} @endif</td>
                    </tr>
                    <tr>
                        <td id="td-table">PTKP</td><td id="td-table">:</td><td id="td-table">@if(isset($payslip->job_position))  {{$payslip->ptkp_status}} @endif</td>
                    </tr>
