                ...
                <div class="col-xl-4">
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <a href="javascript:;" data-attr="{{route('payroll.setting.deductions.create')}}" class="btn btn-default  btn-icon-sm btn-sm btn-add-deduction">
                                    <i class="la la-list"></i>
                                    Add 
                                </a>
                            </div>
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-portlet__body">
                                ...
                                <div class="row pt-5">
                                     ...
                                     <div class="col-2">
                                        <button type="button" data-attr="{{route("payroll.setting.deductions.edit",$row->id)}}"  class="btn btn-outline-warning btn-elevate btn-icon btn-edit-deduction" title="Edit"><i class="la la-edit"></i></button>
                                    </div>
                                    <div class="col-2">
                                        <button type="button" data-attr="{{route("payroll.setting.deductions.show",$row->id)}}"  class="btn btn-outline-danger btn-elevate btn-icon btn-delete-deduction" title="Delete"><i class="flaticon-delete"></i></button>
                                    </div>
                                </div>
                                @endforeach
                            </div>
