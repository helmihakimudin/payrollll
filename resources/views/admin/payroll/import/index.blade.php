    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Import Gaji</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <form method="POST" action="{{ route('payroll.import') }}" id="form-import" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="group">
                        <div class="form-group text-center">
                            ...
                            <input type="file" name="import" id="upload" class="form-control">
