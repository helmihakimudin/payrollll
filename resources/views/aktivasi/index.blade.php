				...
				<div class="kt-portlet kt-portlet--height-fluid">
					<div class="kt-portlet__body p-lg-5">
						...
						<div class="kt-widget kt-widget--user-profile-4">
							...
							<div class="kt-widget__body text-center">
								<h6 class="kt-font-bolder">Dear {{ $employee->full_name}}</h6>
								...
								<a href="{{route('aktivasi.create',$employee->id)}}" class="btn btn-success my-4">Active your account</a>

								<p>Your log in email is <span class="kt-font-bold text-primary">{{ $employee->email}}</span></p>
