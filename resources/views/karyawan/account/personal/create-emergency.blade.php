...
<div class="modal-body">
    <form action="{{route('emp.account.personal.emergency.store',Auth::guard('emp')->user()->id)}}" method="POST" class="form" id="form-personal-emergency" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12">
