...
@include('karyawan.account.contract.modal')
<div class="kt-portlet">
    <div class="kt-portlet__head">
        ...
        <div class="kt-portlet__head-toolbar">
            <a href="javascript:;" data-attr="{{route('emp.contract.create',Auth::guard('emp')->user()->id)}}" class="btn btn-default  btn-icon-sm btn-sm btn-add-contract">
