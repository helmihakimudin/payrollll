...
<div class="kt-portlet">
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            ...
            <input type="hidden" id="empId" name="empId" value="{{Auth::guard('emp')->user()->id}}">
        </div>
...
<div class="modal fade" id="kt_modal_2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="kt-form" action="{{route('emp.account.timeoff.post')}}" method="post" enctype="multipart/form-data">
            @csrf
...
<script>
    ...
    $(document).ready(function() {
            ...
            $('#kt_modal_1').on('show.bs.modal', event => {
                ...
                $.ajax({
                    url: `/emp/delegation-modal/${delegation}`, // the url for your show method
                    method: 'get'
                })
            ...
            $('#kt_modal_8').on('show.bs.modal', event => {
                ...
                $.ajax({
                    url: `/emp/timeoff-modal/${timeoff}`, // the url for your show method
                    method: 'get'
                })
                .done(view => modalBody.html(view));
                // .fail(error => console.error(error));
            ...
            $('#kt_modal_4').on('show.bs.modal', event => {
                ...
                $.ajax({
                    url: `/emp/timeoff-img-modal/${timeoff}`, // the url for your show method
                    method: 'get'
                })
                .done(view => modalBody.html(view));
                // .fail(error => console.error(error));
    ...
    function igniteDelegation() {
        ...
        function igniteTaken() {
            ...
            table.DataTable({
                ...
                ajax: {
                    url: "{{ route('emp.timeoffTaken.ajax') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                    }
        ...
        $(document).on("click", "#cancelButton", function(e){
            let id = $(this).data("id") ;
            // let id = $('#empId').val();
            var url = '{{ route("emp.account.timeoff.cancel", ":id") }}';
            url = url.replace(':id', id);
            $('#idtime').attr('value', id);
            $('#cancelTimeoff').attr('action', url);
        });
        ...
        $(document).on("click", "#btnCancel", function(e) {
            ...
            $.ajax({
                url: `/emp/account/timeoff/canceled/${id}`,
                type: "POST",
                data: {"id": id},
                dataType: "json",
                processData: false,
        ...
        $(document).on("click", "#cancelButtonDelegation", function(e){
            let id = $(this).data("id") ;
            // let id = $('#empId').val();
            var url = '{{ route("emp.account.timeoff.delegation.cancel", ":id") }}';
            url = url.replace(':id', id);
        ...
        $(document).on("click", "#btnCancelDelegation", function(e) {
            ...
            $.ajax({
                url: `/emp/account/timeoff/delegation/canceled/${id}`,
                type: "post",
                data: {"id": id},
                dataType: "json",
                processData: false,
        ...
        $(document).on("click", "#request_delegation_btn", function(e){
            let id = $('#empId').val();
            var url = '{{ route("emp.account.timeoff.delegation", ":id") }}';
            url = url.replace(':id', id);
        ...
        $(document).on("click", "#btnSubmit", function(e) {
            ...
            let id = $('#empId').val();
            // console.log(id);
            let delegateFrom   = $('#delegateFrom').val();
            let employee_id = $('#select-employee2').val();
            ...
            $.ajax({
                url: `/emp/account/timeoff/delegation/${id}`,
                type: "post",
                data: dataForms,
                dataType: "json",
                processData: false,
